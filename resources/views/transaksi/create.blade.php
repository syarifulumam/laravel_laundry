            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="antar_laundry" class="form-control custom-select" name="antar_laundry">
                    ...
                    <option value="Ya" {{ old('antar_laundry') == 'Ya' ? 'selected':'' }}>Ya</option>
                    <option value="Tidak" {{ old('antar_laundry') == 'Tidak' ? 'selected':'' }}>Tidak</option>
                  </select>
                  @error('antar_laundry')
                      <span class="text-sm text-danger">{{ $message }}</span>
                  @enderror
                ...
                <div class="form-group">
                  ...
                  <select class="form-control custom-select" name="paket_laundry_id">
                    ...
                    <option value="{{ $item->id }}" {{ old('paket_laundry_id') == $item->id ? 'selected':'' }}>{{ $item->nama_paket }}</option>
                    @endforeach
                  </select>
